...
export class BasicNft extends Contract {
  ...
  functions: {
    ...
    mintNft(own: string, overrides?: Overrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    mintNft(own: string, overrides?: CallOverrides): Promise<void>;

    "mintNft(address)"(own: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    DogMinted(tokenId: BigNumberish | null): EventFilter;
  ...
  estimateGas: {
    ...
    mintNft(own: string, overrides?: Overrides): Promise<BigNumber>;

    "mintNft(address)"(own: string, overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    mintNft(own: string, overrides?: Overrides): Promise<PopulatedTransaction>;
